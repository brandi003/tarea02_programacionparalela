...
{		
	...
	//////////////////////////////////////////////////////////////////////////////
		...
		std::cout << "-------------------------------"<< std::endl;*/
		conttimer0+=timer0.elapsed();
		conttimer1+=timer1.elapsed();
		conttimer2+=timer2.elapsed();
		conttimer3+=timer3.elapsed();
		conttimer4+=timer4.elapsed();
}
	std::cout << "timer0-->" << conttimer0/(m+1) << std::endl;
	std::cout << "timer1-->" << conttimer1/(m+1) << std::endl;
	std::cout << "timer2-->" << conttimer2/(m+1) << std::endl;
	std::cout << "timer3-->" << conttimer3/(m+1) << std::endl;
	std::cout << "timer4-->" << conttimer4/(m+1) << std::endl;
		return(EXIT_SUCCESS);}
