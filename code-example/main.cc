...
//_mm_storeu_si64(vectorOut1,Registro1);
std::cout <<  (uint16_t)Registro1[0] << std::endl;
std::cout <<  (uint16_t)Registro1[1] << std::endl;
std::cout <<  (uint16_t)Registro1[2] << std::endl;
std::cout <<  (uint16_t)Registro1[3] << std::endl;
